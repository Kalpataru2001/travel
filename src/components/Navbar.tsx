...
export default function Navbar({
  ...
  return (
    <nav className="navbar">
      {/* Brand / Logo */}
      <div className="navbar-brand" onClick={() => onViewChange('planner')}>
        <div className="navbar-logo-icon">🌍</div>
        <span className="navbar-brand-text">AI Travel Guide</span>
      </div>

      {/* Center Navigation Tabs — only shown when user is logged in */}
      {user && (
      ...
      <div className="navbar-right">
        ...
        {/* Save Trip — ALWAYS visible when a trip is loaded (auth check happens on click) */}
        {tripData && currentView === 'planner' && onSaveTrip && (
